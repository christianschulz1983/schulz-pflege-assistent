...
async function selbsttest() {
    ...
    try {
        ...
        if (typeof printAppealText === 'function') {
            ...
            // Das Druckfenster selbst (seit v66.58 hinter der Anlagenauswahl): ohne Anlagen
            druckeStellungnahme([]);
        ...
        if (typeof seitenAufteilen === 'function') {
            ...
            pruefeWahr('Die Aufteilung wird ins Druckfenster übertragen',
                druckeStellungnahme.toString().includes('seitenAufteilen.toString()'));
        }
