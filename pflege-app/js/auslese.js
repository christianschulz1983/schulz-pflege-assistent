...
async function aiReadGutachten(event, ziel) {
    ...
    reader.onload = async () => {
        try {
            ...
            1. Name (stam_betreffend): IMMER im Format "Herr Vorname Nachname" bzw. "Frau Vorname Nachname" (Anrede + Vorname + Nachname). Die Anrede (Herr/Frau) aus dem Adress-/Briefkopf übernehmen (z.B. "Herrn Max Mustermann" -> "Herr Max Mustermann"). NICHT als "Nachname, Vorname" zurückgeben.
            1a. BUCHSTABENGENAUIGKEIT BEIM NAMEN – höchste Sorgfalt: Der Name steht im Dokument mehrfach (Anschrift, Kopfzeile, Fließtext). Vergleiche diese Stellen miteinander und übernimm die Schreibweise, die dort übereinstimmend steht. Achte besonders auf Zeichen, die leicht verwechselt werden: kleines l gegen großes I gegen i gegen die Ziffer 1; rn gegen m; cl gegen d; 0 gegen O; 5 gegen S; 8 gegen B; ü gegen u. Beispiel: "Mahl" (mit kleinem L am Ende) darf nicht zu "Mahi" werden. Rate nie – im Zweifel die Schreibweise aus der Anschrift des Bescheids nehmen.
            2. Geburtsdatum (stam_geboren): MUSS immer ausgelesen werden. IMMER im Format tt.mm.jjjj zurückgeben (z.B. "01.01.1950"). Das gilt für ALLE Datumsfelder (geboren, Antrag, Bescheid, Begutachtung).
